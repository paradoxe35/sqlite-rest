...
// GET registers a GET handler for the API router if path starts with /api/, otherwise for the data router
...
// POST registers a POST handler for the API router if path starts with /api/, otherwise for the data router
...
// PATCH registers a PATCH handler for the API router if path starts with /api/, otherwise for the data router
...
// PUT registers a PUT handler for the API router if path starts with /api/, otherwise for the data router
...
// DELETE registers a DELETE handler for the API router if path starts with /api/, otherwise for the data router
...
// OPTIONS registers an OPTIONS handler for the API router if path starts with /api/, otherwise for the data router
